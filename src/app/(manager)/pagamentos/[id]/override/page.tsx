...
export const metadata: Metadata = { title: 'Ajustar valor' }
  ...
  return (
    <div className="p-4 lg:p-8">
      <div className="mb-6">
        ...
        <h1 className="font-display text-2xl font-bold text-[var(--text)]">Ajustar valor</h1>
      ...
      <div className="max-w-md">
        <div className="mb-6 rounded-xl border border-[rgba(250,204,21,0.3)] bg-[rgba(250,204,21,0.06)] p-4">
          <p className="text-sm text-yellow-400">
            O valor calculado será preservado para auditoria. O motivo do ajuste é obrigatório.
          </p>
        </div>
